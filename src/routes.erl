...
route(<<"post",_/binary>>) -> post;   % github static
route(<<"new",_/binary>>) -> new;   % github static
route(<<"app/index",_/binary>>) -> index; % priv static
route(<<"app/login",_/binary>>) -> login; % priv static
route(<<"app/post",_/binary>>) -> post; % priv static
route(<<"app/new",_/binary>>) -> new; % priv static
route(_) -> login.
